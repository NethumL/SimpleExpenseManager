...
public class PersistentExpenseManager extends ExpenseManager {
    ...
    private static final String[] SQL_CREATE_COMMANDS = {
            String.format("CREATE TABLE %s(%s text PRIMARY KEY, %s text, %s text, %s text);",
            ...
            String.format(
                    "CREATE TABLE %s(%s int PRIMARY KEY, %s timestamp, %s text, %s text, %s text, FOREIGN KEY (%s) REFERENCES %s(%s));",
